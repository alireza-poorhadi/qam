        ...
        <div class="pure-u-1">
            <div id="questions">
                ...
                <?php if(sizeof($questions) == 0): ?>
                    <p style="color: white;">مورد نشان شده‌ای وجود ندارد.</p>
                <?php endif; ?>
                    ...
                    <div class="questionBox <?= (isAdmin() and $question['verified'] == 0) ? 'questionBoxPending' : '' ?>">
                        <div class="question">
                                <div class="a">
                                    ...
                                    <?php endif ?>
                                    <span class="star qMeta" data-star="<?= $question['id'] ?>" style="color: rgb(202, 60, 60);">حذف نشان</span>
                                </div>
